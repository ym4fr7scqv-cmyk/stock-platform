...
class AnalysisWorker:
    ...
    def _l4_system_prompt(self) -> str:
        return (
            ...
            "6. signals: من 2 إلى 4 عناصر فقط — لا ٭تو\n"
            ...
            " (الإيرادات + صافي الربح + إجمالي الأعول).\n"
            ...
            " غياب تصنيف delta أو تفسير السبة لا يبرر DATA_INSUFFICIENT إذا كانت الأرقام متاحة.\n\n"
            "قاعدة ANALYST DATA — صارمة:\n"
            " لا تذكر عدد المحللين أو إجماع المحللين أو السعر المستهدف\n"
            " إلا إذا كانت هذه الحقول مُعطاة صراحةً في قسم 'المحللون' بقيم غير 'غير محدد' وغير 'غير متاح'.\n"
            " إذا كانت قيم المحللين غير متاحة → لا تذكرها نهائياً في التحليل.\n\n"
